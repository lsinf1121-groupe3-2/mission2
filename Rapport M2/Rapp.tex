...
Les méthodes de la classe LinkedRBinaryTree sont de complexité O(1). Sauf les méthodes suivantes : size, search, toString. Soit n, le nombre de noeud dans l'arbre. La complexité de ces méthodes est de O(n). Pour les méthode size et toString, l'ensemble des noeuds de l'arbre seront obligatoirement visité. Pour la méthode search, dans le pire des cas (si l'algorithme ne trouve pas l'élément recherché), l'ensemble des noeuds seront parcourrus.
